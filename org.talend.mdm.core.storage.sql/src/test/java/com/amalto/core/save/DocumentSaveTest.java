...
public class DocumentSaveTest extends TestCase {
...

            {
                ...
                put("report2", new ArrayList<String[]>() {

                    {
                        ...
                        add(new String[] { "Kids/Kid[2]/Habits", "", "" });
                    }
                });
    ...
    public void testDeleteInheritanceReocrds() throws Exception {
        ...
        records.add(factory.read(repository, repository.getComplexType("Employee"),
                "<Employee><id>2</id><name>Employee</name><role>Employee</role></Employee>"));
        records.add(factory.read(repository, repository.getComplexType("Manager"),
                "<Manager><id>3</id><name>Manager</name><title>Manager</title></Manager>"));
        try {
            storage.begin();
