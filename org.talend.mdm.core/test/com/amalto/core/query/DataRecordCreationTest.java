...
public class DataRecordCreationTest extends TestCase {
    ...
    public void testCreationFromXMLString() throws Exception {
        ...
        DataRecord dataRecord = dataRecordReader.read("TestDataCluster", 1, product, builder.toString());
    ...
    public void testCreationFromSAX() throws Exception {
        ...
        DataRecord dataRecord = dataRecordReader.read("TestDataCluster", 1, product, input);
    ...
    public void testCreationFromDOM() throws Exception {
        ...
        DataRecord dataRecord = dataRecordReader.read("TestDataCluster", 1, product, document.getDocumentElement());
