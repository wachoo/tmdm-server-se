...
public class StorageIntegrityTest extends TestCase {
    ...
    public void test1() throws Exception {
        ...
        try {
            ...
            DataRecord record = factory.read("MDM", 1, type, "<Metadata3_Main_1><Id>1</Id><ref>[999]</ref></Metadata3_Main_1>");
            storage.begin();
    ...
    public void test2() throws Exception {
        ...
        try {
            DataRecordReader<String> factory = new XmlStringDataRecordReader();
            DataRecord record = factory.read("MDM", 1, type, "<Metadata3_Main_2><Id>1</Id><ref>[999]</ref></Metadata3_Main_2>");
            try {
                storage.begin();
                storage.update(record);
    ...
    public void test3() throws Exception {
        ...
        try {
            DataRecordReader<String> factory = new XmlStringDataRecordReader();
            DataRecord record = factory.read("MDM", 1, type, "<Metadata3_Main_3><Id>1</Id><ref>[999]</ref><ref>[1000]</ref></Metadata3_Main_3>");
            storage.begin();
            storage.update(record);
            try {
                storage.commit();
    ...
    public void test4() throws Exception {
        ...
        try {
            DataRecordReader<String> factory = new XmlStringDataRecordReader();
            DataRecord record = factory.read("MDM", 1, type, "<Metadata3_Main_4><Id>1</Id><ref>[999]</ref><ref>[1000]</ref></Metadata3_Main_4>");
            try {
                storage.begin();
                storage.update(record);
                storage.commit(); // Should not fail (integrity constraint is switched off in this model).
    ...
    public void test5() throws Exception {
        ...
        try {
            DataRecordReader<String> factory = new XmlStringDataRecordReader();
            DataRecord record = factory.read("MDM", 1, type, "<Metadata3_Main_5><Id>1</Id><ref/></Metadata3_Main_5>");
            storage.begin();
            try {
                storage.update(record);
                storage.commit();
    ...
    public void test6() throws Exception {
        ...
        try {
            DataRecordReader<String> factory = new XmlStringDataRecordReader();
            DataRecord record = factory.read("MDM", 1, type, "<Metadata3_Referenced_6><Id>1</Id><field/></Metadata3_Referenced_6>");
            storage.begin();
            try {
                storage.update(record);
                storage.commit();
    ...
    public void test7() throws Exception {
        ...
        try {
            ...
            record = factory.read("MDM", 1, type, "<Metadata3_Referenced_6><Id>1</Id><field>Field Value</field></Metadata3_Referenced_6>");
            storage.begin();
            storage.update(record);
            storage.commit();
        } finally {
