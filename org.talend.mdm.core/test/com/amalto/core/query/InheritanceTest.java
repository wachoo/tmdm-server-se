...
public class InheritanceTest extends StorageTestCase {
    ...
    public void testTypeOrdering() throws Exception {
        ...
        String[] expectedOrder = { "EntityWithQuiteALongNameWithoutIncludingAnyUnderscore", "Group", "ProductFamily", "Persons", "Employee", "TypeA", "Update",
                "ff", "E1", "E2", "Country", "Address", "Person", "Supplier", "Manager", "B", "D", "A", "C", "a2", "a1", "Store", "Product" };
        */
