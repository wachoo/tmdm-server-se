...
public class FKConstraintTest extends TestCase {
    ...
    public void testMaster(){
        ...
        recordCs.add(factory.read("1", repository, entityC, ENTITY_C1));
        recordCs.add(factory.read("1", repository, entityC, ENTITY_C2));      
        try {
            storage.begin();
        ...
        try {
            storage.begin();
            storage.update(factory.read("1", repository, entityA1, ENTITY_A1_1));
            storage.commit();
        } catch(Exception e){
            e_a11 = e;
        } finally {
        ...
        try {
            storage.begin();
            storage.update(factory.read("1", repository, entityA1, ENTITY_A1_2));
            storage.commit();
        } catch(Exception e){
            e_a12 = e;
        } finally {
        ...
        try {
            storage.begin();
            storage.update(factory.read("1", repository, entityA2, ENTITY_A2_1));
            storage.commit();
        } catch(Exception e){
            e_a21 = e;
        } finally {
        ...
        try {
            storage.begin();
            storage.update(factory.read("1", repository, entityA2, ENTITY_A2_2));
            storage.commit();
        } catch(Exception e){
            e_a22 = e;
        } finally {
