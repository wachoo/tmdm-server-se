...
public class DataRecordDefaultWriterTest extends TestCase {
    ...
    public void testWrite() throws IOException {
        ...
        FieldMetadata fieldMetadata = new ReferenceFieldMetadata(null, true, false, true, "referenceField", null, null, Collections.<FieldMetadata>emptyList(), true, true, null, null, null, null, StringUtils.EMPTY); //$NON-NLS-1$
