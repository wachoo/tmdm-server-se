...
public interface AutoIdGenerator {
     ...
     *
     *
     * @param universe        The universe name (<code>null</code> is interpreted same as "[HEAD]").
     ...
     */
    String generateId(String universe, String dataClusterName, String conceptName, String keyElementName);
    ...
    /**
     * Performs all implementation needed operation to serve correct results in {@link #generateId(String, String, String, String)}.
