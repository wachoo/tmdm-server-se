...
public class CreateWithProvidedIdActions extends CreateActions {
    ...
    CreateWithProvidedIdActions(MutableDocument document, Date date, String source, String userName, String dataCluster, String dataModel, String universe, SaverSource saverSource) {
        super(document, date, source, userName, dataCluster, dataModel, universe, saverSource);
    }
