...
public abstract class IXtentisWSDelegator implements IBeanDelegator {
    ...
    public WSVersion getComponentVersion(WSGetComponentVersion wsGetComponentVersion) throws RemoteException {
        try {
            if (WSComponent.DataManager.equals(wsGetComponentVersion.getComponent())) {
                ...
                return new WSVersion(version.getMajor(), version.getMinor(), version.getRevision(), version.getBuild(), version
                        .getDescription(), version.getDate());
            }
    ...
    public WSDataModel getDataModel(WSGetDataModel wsDataModelget) throws RemoteException {
        try {
            return VO2WS(Util.getDataModelCtrlLocal()
                    .getDataModel(new DataModelPOJOPK(wsDataModelget.getWsDataModelPK().getPk())));
        } catch (Exception e) {
            throw new RemoteException((e.getCause() == null ? e.getLocalizedMessage() : e.getCause().getLocalizedMessage()));
        }
    }
    ...
    public WSDataModelPK deleteDataModel(WSDeleteDataModel wsDeleteDataModel) throws RemoteException {
        try {
            return new WSDataModelPK(Util.getDataModelCtrlLocal().removeDataModel(
                    new DataModelPOJOPK(wsDeleteDataModel.getWsDataModelPK().getPk())).getUniqueId());
        } catch (Exception e) {
            throw new RemoteException((e.getCause() == null ? e.getLocalizedMessage() : e.getCause().getLocalizedMessage()));
        }
    }
    ...
    public WSConceptKey getBusinessConceptKey(WSGetBusinessConceptKey wsGetBusinessConceptKey) throws RemoteException {
        try {
            String schema = Util.getDataModelCtrlLocal().getDataModel(
                    new DataModelPOJOPK(wsGetBusinessConceptKey.getWsDataModelPK().getPk())).getSchema();
    ...
    public WSDataClusterPK deleteDataCluster(WSDeleteDataCluster wsDeleteDataCluster) throws RemoteException {
        try {
            return new WSDataClusterPK(Util.getDataClusterCtrlLocal().removeDataCluster(
                    new DataClusterPOJOPK(wsDeleteDataCluster.getWsDataClusterPK().getPk())).getUniqueId());
        } catch (Exception e) {
            throw new RemoteException((e.getCause() == null ? e.getLocalizedMessage() : e.getCause().getLocalizedMessage()));
        }
    }
    ...
    public WSStringArray getConceptsInDataCluster(WSGetConceptsInDataCluster wsGetConceptsInDataCluster) throws RemoteException {
        try {
            ...
            Set<String> concepts = Util.getItemCtrl2Local().getConceptsInDataCluster(
                    new DataClusterPOJOPK(wsGetConceptsInDataCluster.getWsDataClusterPK().getPk())).keySet();
    ...
    public WSItemPKsByCriteriaResponse getItemPKsByFullCriteria(WSGetItemPKsByFullCriteria wsGetItemPKsByFullCriteria)
        ...
        return doGetItemPKsByCriteria(wsGetItemPKsByFullCriteria.getWsGetItemPKsByCriteria(), wsGetItemPKsByFullCriteria
                .isUseFTSearch());
    }
    ...
    public WSItem getItem(WSGetItem wsGetItem) throws RemoteException {
        try {
            ...
            return new WSItem(wsGetItem.getWsItemPK().getWsDataClusterPK(), pojo.getDataModelName(), pojo.getDataModelRevision(),
                    wsGetItem.getWsItemPK().getConceptName(), wsGetItem.getWsItemPK().getIds(), pojo.getInsertionTime(), pojo
    ...
    public WSString getBusinessConceptValue(WSGetBusinessConceptValue wsGetBusinessConceptValue) throws RemoteException {
        try {
            /*
             * ItemValue iv = Util.getItemCtrl2Local().getItem( new ItemPK( new
             * DataClusterPOJOPK(wsGetBusinessConceptValue.getWsDataClusterPK().getPk()),
             * wsGetBusinessConceptValue.getWsBusinessConceptPK().getConceptName(),
             * wsGetBusinessConceptValue.getWsBusinessConceptPK().getIds() ) ); return new WSString(itemAsString(iv));
             */
     ...
     * 
     * DocumentValue dvo = DocumentCtrl2Util.getLocalHome().create().getDocument(iv.getDocument()); InboundAdaptorValue
     * iavo = dvo.getInboundAdaptor();
     * 
     * String item = "<businessconcept>" + "	<cluster>"+iv.getDataCluster().getName()+"</cluster>" +
     * "	<source>"+iavo.getSource().getName()+"</source>" + "	<document>"+iv.getDocument().getName()+"</document>";
     * String[] ids = iv.getItemIds(); for (int i = 0; i < ids.length; i++) { item+="	<id>"+ids[i]+"</id>"; } item+=
     * "	<lastmodifiedtime>"+iv.getInsertionTime()+"</lastmodifiedtime>"; item+=
     * "	<projection>"+iv.getProjection()+"</projection>" ; item+= "</businessconcept>";
     * 
     * return item; }
     */
    ...
    protected WSItemPK putItem(WSPutItem wsPutItem, DataModelPOJO dataModel, Document schema, String[] itemKeyValues,
        ...
        try {
            ...
            if (XSystemObjects.DC_PROVISIONING.getName().equals(dataModel.getName())
                    && LocalUser.getLocalUser().getUsername().equals(itemKeyValues[0])) {
    ...
    public WSItemPK putItem(WSPutItem wsPutItem) throws RemoteException {
        try {
            ...
            if (("AutoIncrement".equals(concept) && wsPutItem.getWsDataModelPK().getPk().equals(XSystemObjects.DC_CONF.getName()))) {
                ...
                itemKeyValues = com.amalto.core.util.Util.getKeyValuesFromItem(root, conceptKey);
            }
            // update the item using new field values see feature 0008854: Update an item instead of replace it
            // load the item first if itemkey provided
    ...
    public WSServiceGetDocument getServiceDocument(WSString serviceName) throws RemoteException {
        try {
            ...
            String desc = "";
            Object descObject = Util.getMethod(service, "getDescription").invoke(service, new Object[] { "" });
            if (descObject != null)
                desc = (String) descObject;

            String configuration = "";
            Object configurationObject = Util.getMethod(service, "getConfiguration").invoke(service, new Object[] { "" });
            ...
            try {
                ...
                if (getDocumentationMethod != null) {
                    Object docObject = getDocumentationMethod.invoke(service, new Object[] { "" });
                    if (docObject != null)
                ...
                if (getDefaultConfigurationMethod != null) {
                    Object defaultConfObject = getDefaultConfigurationMethod.invoke(service, new Object[] {});
                ...
                if (getConfigurationSchemaMethod != null) {
                    Object schemaObject = getConfigurationSchemaMethod.invoke(service, new Object[] {});
    ...
    public WSCheckServiceConfigResponse checkServiceConfiguration(WSCheckServiceConfigRequest serviceName) throws RemoteException {
        try {
            Object service = Util.retrieveComponent(null, "amalto/local/service/" + serviceName.getJndiName());

            Boolean result = (Boolean) Util.getMethod(service, "checkConfigure").invoke(service,
    ...
    protected TransformerPOJO WS2POJO(WSTransformer wsTransformer) throws Exception {
        ...
        if (wsSpecs != null) {
            for (int i = 0; i < wsSpecs.length; i++) {
                TransformerPluginSpec spec = new TransformerPluginSpec(wsSpecs[i].getPluginJNDI(), wsSpecs[i].getDescription(),
                        wsSpecs[i].getInput(), wsSpecs[i].getOutput(), wsSpecs[i].getParameters());
                specs.add(spec);
            }
        }
    ...
    public WSPipeline processBytesUsingTransformer(WSProcessBytesUsingTransformer wsProjectBytes) throws RemoteException {
        try {
            TransformerPluginContext context = Util.getTransformerCtrlLocal().process(
                    new com.amalto.core.util.TypedContent(null, wsProjectBytes.getWsBytes().getBytes(), wsProjectBytes
                            .getContentType()), new TransformerPOJOPK(wsProjectBytes.getWsTransformerPK().getPk()),
    ...
    public WSBackgroundJobPK processBytesUsingTransformerAsBackgroundJob(
        ...
        try {
            return new WSBackgroundJobPK(Util.getTransformerCtrlLocal().processBytesAsBackgroundJob(
    ...
    public WSBackgroundJobPK processFileUsingTransformerAsBackgroundJob(
        ...
        try {
            return new WSBackgroundJobPK(Util.getTransformerCtrlLocal().processFileAsBackgroundJob(
    ...
    // ArrayList<WSProcessBytesUsingTransformerWsOutputDecisionTableDecisions> decisions = new
    // ArrayList<WSProcessBytesUsingTransformerWsOutputDecisionTableDecisions>();
    ...
    // }
    // WSOutputDecisionTable table = new WSOutputDecisionTable(decisions.toArray(new
    // WSProcessBytesUsingTransformerWsOutputDecisionTableDecisions[decisions.size()]));
    // return table;
    // }
    ...
    protected WSPipeline POJO2WSOLD(HashMap<String, com.amalto.core.util.TypedContent> pipeline) throws Exception {
        ...
        for (Iterator iter = keys.iterator(); iter.hasNext();) {
            ...
            WSPipelineTypedContentEntry wsEntry = new WSPipelineTypedContentEntry(TransformerCtrlBean.DEFAULT_VARIABLE
    ...
    protected WSDroppedItem POJO2WS(DroppedItemPOJO droppedItemPOJO) throws Exception {
        ...
        WSDroppedItem wsDroppedItem = new WSDroppedItem(droppedItemPOJO.getRevisionID(), new WSDataClusterPK(droppedItemPOJO
    ...
    public WSRoutingRulePK deleteRoutingRule(WSDeleteRoutingRule wsDeleteRoutingRule) throws RemoteException {
        try {
            return new WSRoutingRulePK(Util.getRoutingRuleCtrlLocal().removeRoutingRule(
                    new RoutingRulePOJOPK(wsDeleteRoutingRule.getWsRoutingRulePK().getPk())).getUniqueId());
        } catch (XtentisException e) {
            throw (new RemoteException(e.getLocalizedMessage()));
        } catch (Exception e) {
            throw new RemoteException((e.getCause() == null ? e.getLocalizedMessage() : e.getCause().getLocalizedMessage()));
    ...
    public WSRoutingRulePKArray getRoutingRulePKs(WSGetRoutingRulePKs regex) throws RemoteException {
        try {
            ...
            Collection c = ctrl.getRoutingRulePKs(regex.getRegex());
            if (c == null)
                return null;
            WSRoutingRulePK[] pks = new WSRoutingRulePK[c.size()];
            int i = 0;
            for (Iterator iter = c.iterator(); iter.hasNext();) {
                pks[i++] = new WSRoutingRulePK(((RoutingRulePOJOPK) iter.next()).getUniqueId());
            }
    ...
    public static HashMap<String, TypedContent> WS2POJO(WSPipeline wsPipeline) throws Exception {
        ...
        for (int i = 0; i < entries.length; i++) {
            pipeline.put(entries[i].getOutput(), new TypedContent(entries[i].getWsExtractedContent().getWsByteArray().getBytes(),
    ...
    public WSTransformerPluginV2Details getTransformerPluginV2Details(
        ...
        try {
            ...
            return new WSTransformerPluginV2Details(wsInputVariableDescriptors
                    .toArray(new WSTransformerPluginV2VariableDescriptor[wsInputVariableDescriptors.size()]),
    ...
    protected Collection<AbstractRoutingOrderV2POJOPK> getRoutingOrdersByCriteria(WSRoutingOrderV2SearchCriteria criteria)
        ...
        try {
            ...
            Collection<AbstractRoutingOrderV2POJOPK> pks = ctrl.getRoutingOrderPKsByCriteria(clazz, criteria
                    .getAnyFieldContains(), criteria.getNameContains(), criteria.getTimeCreatedMin(), criteria
                    .getTimeCreatedMax(), criteria.getTimeScheduledMin(), criteria.getTimeScheduledMax(), criteria
                    .getTimeLastRunStartedMin(), criteria.getTimeLastRunStartedMax(), criteria.getTimeLastRunCompletedMin(),
                    criteria.getTimeLastRunCompletedMax(), criteria.getItemPKConceptContains(), criteria
                            .getItemPKIDFieldsContain(), criteria.getServiceJNDIContains(), criteria
                            .getServiceParametersContain(), criteria.getMessageContain());
    ...
    public WSAutoIncrement getAutoIncrement(WSAutoIncrement request) throws RemoteException {
        try {
            if (request == null) {
                ...
                Util.getXmlServerCtrlLocal().putDocumentFromString(request.getAutoincrement(), "Auto_Increment",
    ...
    public WSCategoryData getMDMCategory(WSCategoryData request) throws RemoteException {
        ...
        try {
            if (request == null) {
                ...
                Util.getXmlServerCtrlLocal().putDocumentFromString(request.getCategorySchema(), "CONF.TREEOBJECT.CATEGORY",
                        "CONF", null);
                return request;
            }
        ...
        try {
            boolean ret = Util.getItemCtrl2Local()
                    .isItemModifiedByOther(
                            new ItemPOJOPK(new DataClusterPOJOPK(item.getWsDataClusterPK().getPk()), item.getConceptName(), item
                                    .getIds()), item.getInsertionTime());
