...
public class StagingTypeMappingRepository extends TypeMappingRepository {
    ...
    public MappingMetadataRepository visit(ComplexTypeMetadata complexType) {
        ...
        typeMapping.addField(new SimpleTypeFieldMetadata(typeMapping, false, false, false, METADATA_STAGING_STATUS, repository.getType(XSD_NAMESPACE, "string"), Collections.<String>emptyList(), Collections.<String>emptyList()));
        typeMapping.addField(new SimpleTypeFieldMetadata(typeMapping, false, false, false, METADATA_STAGING_ERROR, repository.getType(XSD_NAMESPACE, "string"), Collections.<String>emptyList(), Collections.<String>emptyList()));
