...
public class DataRecordJSONWriter implements DataRecordWriter {
    ...
    private boolean isLowerCaseAttribute = false;

    private SecuredStorage.UserDelegator delegator = SecuredStorage.UNSECURED;

    public DataRecordJSONWriter(boolean isLowerCaseAttribute) {
        this.isLowerCaseAttribute = isLowerCaseAttribute;
    }
    ...
    private String generateAttributeName(String name) {
        return isLowerCaseAttribute ? name.toLowerCase() : name;
    }
}
