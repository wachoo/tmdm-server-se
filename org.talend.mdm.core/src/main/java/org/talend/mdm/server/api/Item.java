...
public interface Item {
     ...
     * @throws com.amalto.core.util.XtentisException
     */
    public java.util.ArrayList xPathsSearch(DataClusterPOJOPK dataClusterPOJOPK, String forceMainPivot, ArrayList<String> viewablePaths, IWhereItem whereItem, int spellThreshold, int start, int limit, boolean returnCount)
            throws com.amalto.core.util.XtentisException, java.rmi.RemoteException;
    ...
    public java.util.ArrayList xPathsSearch(DataClusterPOJOPK dataClusterPOJOPK, String forceMainPivot,
                                            ...
                                            int start, int limit, boolean returnCount)
            throws com.amalto.core.util.XtentisException, java.rmi.RemoteException;
