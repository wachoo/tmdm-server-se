...
public interface StorageAdmin {
     ...
     * @param type             The storage {@link org.talend.mdm.storage.StorageType type} (Staging, Master...).
     * @param revisionID       A revision id (or null for HEAD revision).
     ...
     * @param storageType Indicates whether caller checks for {@link org.talend.mdm.storage.StorageType#MASTER} or {@link org.talend.mdm.storage.StorageType#STAGING}.  @return Returns <code>true</code> if storage already exist for this name, revision and type.
    ...
    /**
     * @param storageName A {@link org.talend.mdm.storage.Storage} name.
     ...
     * @see #create(String, String, org.talend.mdm.storage.StorageType, String, String)
     */
     ...
     * @return The {@link org.talend.mdm.storage.StorageType type} of storage to be associated with the name.
     */
