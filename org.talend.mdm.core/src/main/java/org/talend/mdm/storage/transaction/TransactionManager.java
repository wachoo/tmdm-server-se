...
public interface TransactionManager {
    ...
    /**
     * @return All ids of currently active transactions (id returned by {@link org.talend.mdm.storage.transaction.Transaction#getId()}).
     */
    List<String> list();
     ...
     * @see Transaction#include(org.talend.mdm.storage.Storage)
     ...
     * @see Transaction#include(org.talend.mdm.storage.Storage)
     * @see #associate(Transaction)
     * @see #create(org.talend.mdm.storage.transaction.Transaction.Lifetime)
     */
     ...
     * to current thread, a new transaction with a life time {@link org.talend.mdm.storage.transaction.Transaction.Lifetime#AD_HOC}
     * is created.
     */
