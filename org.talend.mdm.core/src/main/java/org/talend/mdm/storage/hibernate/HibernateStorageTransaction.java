...
import org.talend.mdm.storage.exception.ConstraintViolationException;
...
class HibernateStorageTransaction extends StorageTransaction {
     ...
     * @param storage A {@link org.talend.mdm.storage.hibernate.HibernateStorage} that can be used to retrieve metadata information for all objects in
     *                <code>session</code>.
     */
