 ...
 * {@link org.talend.mdm.storage.hibernate.ScatteredMappingCreator} instances to get database column names.
 */
public interface MappingCreatorContext {
     ...
     * @see org.talend.mdm.storage.datasource.RDBMSDataSource.DataSourceDialect#getTextLimit()
     */
    int getTextLimit();
}
