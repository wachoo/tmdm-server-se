package org.talend.mdm.storage.inmemory;
...
import org.talend.mdm.storage.inmemory.matcher.*;
...
import org.talend.mdm.storage.transaction.StorageTransaction;
import org.talend.mdm.storage.transaction.TransactionManager;

/**
 * A (very) simple implementation of storage to provide a {@link org.talend.mdm.storage.Storage storage} API over a
 * group of {@link org.talend.mdm.storage.record.DataRecord records} in memory.
 */
