...
amalto.core = function () {
	...
	*************/
	...
	function initUI() {
		...
		loadGroupingHierarchy();

		contentPanel.doLayout(); 
	}

	
	function loadGroupingHierarchy() {
		amalto.core.loadMainScript("hierarchical", "GroupingHierarchy",
				function() {
					var initFunction = "amalto.hierarchical.GroupingHierarchy.init()";
