...
Ext.override(Ext.grid.GridPanel, {
    getExcelXml: function(includeHidden, criteria) {
        var worksheet = this.createWorksheet(includeHidden, criteria);
    ...
    createWorksheet: function(includeHidden, criteria) {
        ...
        var t = '<ss:Worksheet ss:Name="' + this.title + '">' +
            ...
            '<html:B>Search Criteria:</html:B>'+ criteria +'</ss:Data><ss:NamedCell ss:Name="Print_Titles" />' +
            '</ss:Cell>' +
            '</ss:Row>' +
