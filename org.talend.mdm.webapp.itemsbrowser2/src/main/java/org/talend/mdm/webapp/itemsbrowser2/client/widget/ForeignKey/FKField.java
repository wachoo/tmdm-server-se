...
public class FKField extends TextField<ForeignKeyBean> {
    ...
    public void Update(String foreignKey, SimpleCriterionPanel panel) {
        relWindow = new FKRelRecordWindow(foreignKey, panel);
