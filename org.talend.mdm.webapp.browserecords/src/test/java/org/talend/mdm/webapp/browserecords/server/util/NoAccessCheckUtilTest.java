...
public class NoAccessCheckUtilTest extends TestCase {
    ...
    public void testCheckNoAccessHelper() throws Exception {
        String modelXSD = getXSDModel(); 
        assertTrue(NoAccessCheckUtil.checkNoAccessHelper(modelXSD, "M28_E01", ROLES)); //$NON-NLS-1$
        assertFalse(NoAccessCheckUtil.checkNoAccessHelper(modelXSD, "M28_E02", ROLES)); //$NON-NLS-1$
    }
    
    private String getXSDModel() throws Exception {
