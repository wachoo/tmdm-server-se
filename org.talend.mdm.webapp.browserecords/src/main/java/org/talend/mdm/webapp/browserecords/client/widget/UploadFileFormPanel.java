...
public class UploadFileFormPanel extends FormPanel implements Listener<FormEvent> {
    ...
    private void renderForm() {
        ...
        viewableXpathField.setValue(org.talend.mdm.webapp.base.shared.util.CommonUtil.convertListToString(
                viewBean.getViewableXpaths(), Constants.FILE_EXPORT_IMPORT_SEPARATOR));
