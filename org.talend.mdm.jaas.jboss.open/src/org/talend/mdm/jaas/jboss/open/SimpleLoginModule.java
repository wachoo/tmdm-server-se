    ...
    <application-policy name="xtentisSecurity">
      <authentication>
        <login-module code="com.amalto.jaas.xtentis.jboss.XtentisLoginModule"
          flag="required">
          <module-option name="logins">administrator,user,john,jack,james, admin, UnauthorizedLoginForTest</module-option>
          <module-option name="passwords">administrator,user,bpm, bpm, bpm, bpm, UnauthorizedPasswordForTest</module-option>
        </login-module>
