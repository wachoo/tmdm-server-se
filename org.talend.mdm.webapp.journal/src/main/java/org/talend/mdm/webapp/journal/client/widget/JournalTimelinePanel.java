...
public class JournalTimelinePanel extends ContentPanel {
    ...
    private void loadTimeline(int startIndex) {
        start = startIndex;
        service.getReportString(startIndex, limit, sort, field, language, entity, key, source, operationType, startDate, endDate,
                isBrowseRecord, new SessionAwareAsyncCallback<String>() {
    ...
    public native void parseResult(String result)/*-{
		...
		if (this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::isInit) {
			...
			this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::eventSource
					.loadJSON(jsonData, document.location.href);
			this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::eventCache[startIndex] = true;
			//			}
		}
    }-*/;
    ...
    public native void renderTimeline(JavaScriptObject jsonData, String dateFormat)/*-{             
       ...
       width : this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::getTimeLinePanelHeight()() * 0.6,          
       ...
       width : this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::getTimeLinePanelHeight()() * 0.3,         
    ...
    public native void getTimeRange(JavaScriptObject band)/*-{
		...
		if (centerVisibleDate
				&& this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::lastCenterVisibleDate) {
			var startIndex = null;

			if (centerVisibleDate.getTime()
					- this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::lastCenterVisibleDate
							.getTime() > 0) {
				startIndex = this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::start
						+ this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::limit;
			} else if (centerVisibleDate.getTime()
					- this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::lastCenterVisibleDate
							.getTime() < 0) {
				startIndex = this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::start
						- this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::limit;
			...
			if (startIndex != null && startIndex >= 0) {
				if (this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::timeOutId) {
					$wnd
							.clearTimeout(this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::timeOutId);
				}
				this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::timeOutId = setTimeout(
						function() {
		...
		this.@org.talend.mdm.webapp.journal.client.widget.JournalTimelinePanel::lastCenterVisibleDate = centerVisibleDate;
    }-*/;
