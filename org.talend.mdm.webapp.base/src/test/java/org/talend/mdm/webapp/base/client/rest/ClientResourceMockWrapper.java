...
public class ClientResourceMockWrapper extends ClientResourceWrapper {
    ...
    public void request() {
        ...
        if (method.equals(Method.GET)
                && uri.matches("^.+/datamanager/services/tasks/matching/explain/Product/groups/\\?type=Product&group=74849595-27be-4b48-9238-cca56c6e6658")) { //$NON-NLS-1$
            ...
            response.setEntity(representation);
                ...
                && uri.matches("^.+/datamanager/services/tasks/matching/explain/\\?model=Product&type=Product")) { //$NON-NLS-1$
