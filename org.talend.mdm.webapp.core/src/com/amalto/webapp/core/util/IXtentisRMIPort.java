...
import com.amalto.webapp.util.webservices.WSBackgroundJobPKArray;
import com.amalto.webapp.util.webservices.WSBase64KeyValue;
import com.amalto.webapp.util.webservices.WSBoolean;
import com.amalto.webapp.util.webservices.WSBusinessConcept;
import com.amalto.webapp.util.webservices.WSCategoryData;
import com.amalto.webapp.util.webservices.WSCheckSchema;
...
import com.amalto.webapp.util.webservices.WSComponent;
import com.amalto.webapp.util.webservices.WSConceptKey;
import com.amalto.webapp.util.webservices.WSConnectorFunction;
import com.amalto.webapp.util.webservices.WSConnectorInteraction;
import com.amalto.webapp.util.webservices.WSConnectorInteractionResponse;
...
import com.amalto.webapp.util.webservices.WSDataClusterPKArray;
import com.amalto.webapp.util.webservices.WSDataModel;
import com.amalto.webapp.util.webservices.WSDataModelPK;
import com.amalto.webapp.util.webservices.WSDataModelPKArray;
import com.amalto.webapp.util.webservices.WSDeleteBusinessConcept;
import com.amalto.webapp.util.webservices.WSDeleteDataCluster;
import com.amalto.webapp.util.webservices.WSDeleteDataModel;
import com.amalto.webapp.util.webservices.WSDeleteItem;
import com.amalto.webapp.util.webservices.WSDeleteItems;
import com.amalto.webapp.util.webservices.WSDeleteMenu;
import com.amalto.webapp.util.webservices.WSDeleteRoutingOrderV2;
import com.amalto.webapp.util.webservices.WSDeleteRoutingRule;
import com.amalto.webapp.util.webservices.WSDeleteStoredProcedure;
import com.amalto.webapp.util.webservices.WSDeleteTransformer;
import com.amalto.webapp.util.webservices.WSDeleteTransformerV2;
import com.amalto.webapp.util.webservices.WSDeleteView;
...
import com.amalto.webapp.util.webservices.WSExecuteRoutingOrderV2Asynchronously;
import com.amalto.webapp.util.webservices.WSExecuteRoutingOrderV2Synchronously;
...
import com.amalto.webapp.util.webservices.WSExecuteTransformerV2AsJob;
import com.amalto.webapp.util.webservices.WSExistsDBDataCluster;
...
import com.amalto.webapp.util.webservices.WSExistsRoutingOrderV2;
import com.amalto.webapp.util.webservices.WSExistsRoutingRule;
import com.amalto.webapp.util.webservices.WSExistsStoredProcedure;
import com.amalto.webapp.util.webservices.WSExistsTransformer;
import com.amalto.webapp.util.webservices.WSExistsTransformerPluginV2;
import com.amalto.webapp.util.webservices.WSExistsTransformerV2;
...
import com.amalto.webapp.util.webservices.WSExtractUsingTransformer;
import com.amalto.webapp.util.webservices.WSExtractUsingTransformerThruView;
import com.amalto.webapp.util.webservices.WSFindAllDroppedItemsPKs;
import com.amalto.webapp.util.webservices.WSFindBackgroundJobPKs;
import com.amalto.webapp.util.webservices.WSGetBackgroundJob;
import com.amalto.webapp.util.webservices.WSGetBusinessConceptKey;
import com.amalto.webapp.util.webservices.WSGetBusinessConceptValue;
import com.amalto.webapp.util.webservices.WSGetBusinessConcepts;
import com.amalto.webapp.util.webservices.WSGetChildrenItems;
import com.amalto.webapp.util.webservices.WSGetComponentVersion;
import com.amalto.webapp.util.webservices.WSGetConceptsInDataCluster;
import com.amalto.webapp.util.webservices.WSGetDataCluster;
import com.amalto.webapp.util.webservices.WSGetDataModel;
import com.amalto.webapp.util.webservices.WSGetFullPathValues;
...
import com.amalto.webapp.util.webservices.WSGetMenuPKs;
import com.amalto.webapp.util.webservices.WSGetRoutingOrderV2;
import com.amalto.webapp.util.webservices.WSGetRoutingOrderV2PKsByCriteria;
import com.amalto.webapp.util.webservices.WSGetRoutingOrderV2SByCriteria;
import com.amalto.webapp.util.webservices.WSGetRoutingRule;
import com.amalto.webapp.util.webservices.WSGetRoutingRulePKs;
import com.amalto.webapp.util.webservices.WSGetServicesList;
...
import com.amalto.webapp.util.webservices.WSGetTransformerPluginV2Details;
import com.amalto.webapp.util.webservices.WSGetTransformerPluginV2SList;
import com.amalto.webapp.util.webservices.WSGetTransformerV2;
import com.amalto.webapp.util.webservices.WSGetTransformerV2PKs;
import com.amalto.webapp.util.webservices.WSGetView;
import com.amalto.webapp.util.webservices.WSGetViewPKs;
import com.amalto.webapp.util.webservices.WSI18NString;
import com.amalto.webapp.util.webservices.WSInitData;
import com.amalto.webapp.util.webservices.WSInt;
import com.amalto.webapp.util.webservices.WSIsItemModifiedByOther;
...
import com.amalto.webapp.util.webservices.WSMDMConfig;
import com.amalto.webapp.util.webservices.WSMenu;
import com.amalto.webapp.util.webservices.WSMenuPK;
import com.amalto.webapp.util.webservices.WSMenuPKArray;
import com.amalto.webapp.util.webservices.WSPing;
import com.amalto.webapp.util.webservices.WSPipeline;
import com.amalto.webapp.util.webservices.WSProcessBytesUsingTransformer;
import com.amalto.webapp.util.webservices.WSProcessBytesUsingTransformerAsBackgroundJob;
import com.amalto.webapp.util.webservices.WSProcessFileUsingTransformer;
import com.amalto.webapp.util.webservices.WSProcessFileUsingTransformerAsBackgroundJob;
import com.amalto.webapp.util.webservices.WSPutBackgroundJob;
import com.amalto.webapp.util.webservices.WSPutBusinessConcept;
import com.amalto.webapp.util.webservices.WSPutBusinessConceptSchema;
import com.amalto.webapp.util.webservices.WSPutDBDataCluster;
...
import com.amalto.webapp.util.webservices.WSPutItemByOperatorType;
import com.amalto.webapp.util.webservices.WSPutItemWithReport;
import com.amalto.webapp.util.webservices.WSPutItemWithReportArray;
import com.amalto.webapp.util.webservices.WSPutMenu;
import com.amalto.webapp.util.webservices.WSPutRoutingRule;
import com.amalto.webapp.util.webservices.WSPutStoredProcedure;
import com.amalto.webapp.util.webservices.WSPutTransformer;
import com.amalto.webapp.util.webservices.WSPutTransformerV2;
import com.amalto.webapp.util.webservices.WSPutView;
import com.amalto.webapp.util.webservices.WSQuickSearch;
...
import com.amalto.webapp.util.webservices.WSRoutingEngineV2Action;
import com.amalto.webapp.util.webservices.WSRoutingEngineV2ActionCode;
import com.amalto.webapp.util.webservices.WSRoutingEngineV2Status;
import com.amalto.webapp.util.webservices.WSRoutingOrderV2;
import com.amalto.webapp.util.webservices.WSRoutingOrderV2Array;
import com.amalto.webapp.util.webservices.WSRoutingOrderV2PK;
import com.amalto.webapp.util.webservices.WSRoutingOrderV2PKArray;
import com.amalto.webapp.util.webservices.WSRoutingOrderV2SearchCriteria;
import com.amalto.webapp.util.webservices.WSRoutingOrderV2Status;
import com.amalto.webapp.util.webservices.WSRoutingRule;
import com.amalto.webapp.util.webservices.WSRoutingRulePK;
import com.amalto.webapp.util.webservices.WSRoutingRulePKArray;
import com.amalto.webapp.util.webservices.WSRunQuery;
...
import com.amalto.webapp.util.webservices.WSServicesList;
import com.amalto.webapp.util.webservices.WSServicesListItem;
import com.amalto.webapp.util.webservices.WSStoredProcedure;
import com.amalto.webapp.util.webservices.WSStoredProcedurePK;
import com.amalto.webapp.util.webservices.WSStoredProcedurePKArray;
...
import com.amalto.webapp.util.webservices.WSTransformerPKArray;
import com.amalto.webapp.util.webservices.WSTransformerPluginV2Details;
import com.amalto.webapp.util.webservices.WSTransformerPluginV2GetConfiguration;
import com.amalto.webapp.util.webservices.WSTransformerPluginV2PutConfiguration;
import com.amalto.webapp.util.webservices.WSTransformerPluginV2SList;
import com.amalto.webapp.util.webservices.WSTransformerPluginV2SListItem;
...
import com.amalto.webapp.util.webservices.WSTransformerV2PKArray;
import com.amalto.webapp.util.webservices.WSVersion;
import com.amalto.webapp.util.webservices.WSView;
import com.amalto.webapp.util.webservices.WSViewPK;
import com.amalto.webapp.util.webservices.WSViewPKArray;
...
public abstract class IXtentisRMIPort implements XtentisPort {
    ...
    public WSItemPK deleteItem(WSDeleteItem wsDeleteItem) throws RemoteException {
        SaverSession session = SaverSession.newSession();
        WSDataClusterPK dataClusterPK = wsDeleteItem.getWsItemPK().getWsDataClusterPK();
        String dataClusterName = dataClusterPK.getPk();
        session.begin(dataClusterName);
        try {
            DocumentSaver saver = SaverHelper.deleteItem(wsDeleteItem.getWsItemPK().getIds(), wsDeleteItem.getOverride(), session,
                    dataClusterName,
                    dataClusterName); // TODO Data model name
            session.end(); // Cause items being saved to be deleted in database.
            String[] savedId = saver.getSavedId();
            String savedConceptName = saver.getSavedConceptName();
            return new WSItemPK(dataClusterPK, savedConceptName, savedId);
        } catch (Exception e) {
