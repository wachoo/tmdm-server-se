...
public class WSStartProcessInstance_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2_myWSWorkflowProcessDefinitionUUID_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSWorkflowProcessDefinitionUUID.class, ns2_WSWorkflowProcessDefinitionUUID_TYPE_QNAME);
        ns2_myWSHashMap_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSHashMap.class, ns2_WSHashMap_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSStartProcessInstance instance = new com.amalto.webapp.util.webservices.WSStartProcessInstance();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        while (reader.getState() == XMLReader.START) {
            ...
            if (elementName.equals(ns1_processUUID_QNAME)) {
                ...
                instance.setProcessUUID((com.amalto.webapp.util.webservices.WSWorkflowProcessDefinitionUUID)member);
                reader.nextElementContent();
            }
                ...
                instance.setVariable((com.amalto.webapp.util.webservices.WSHashMap)member);
                reader.nextElementContent();
            }
            else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSStartProcessInstance instance = (com.amalto.webapp.util.webservices.WSStartProcessInstance)obj;
