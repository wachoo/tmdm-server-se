...
// JAX-RPC Standard Implementation 锟斤拷1.1.2_01锟斤拷锟斤拷锟斤拷锟� R40锟斤拷
...
public interface XtentisPort extends java.rmi.Remote {
    ...
    public com.amalto.webapp.util.webservices.WSStringArray getItems(com.amalto.webapp.util.webservices.WSGetItems wsGetItems) throws 
         java.rmi.RemoteException;
    public com.amalto.webapp.util.webservices.WSStringArray getItemsSort(com.amalto.webapp.util.webservices.WSGetItemsSort wsGetItemsSort) throws 
         java.rmi.RemoteException;
    ...
    public com.amalto.webapp.util.webservices.WSItemPKsByCriteriaResponse getItemPKsByFullCriteria(com.amalto.webapp.util.webservices.WSGetItemPKsByFullCriteria wsGetItemPKsByFullCriteria) throws 
         java.rmi.RemoteException;
    public com.amalto.webapp.util.webservices.WSString countItemsByCustomFKFilters(com.amalto.webapp.util.webservices.WSCountItemsByCustomFKFilters wsCountItemsByCustomFKFilters) throws 
         java.rmi.RemoteException;
    public com.amalto.webapp.util.webservices.WSStringArray getItemsByCustomFKFilters(com.amalto.webapp.util.webservices.WSGetItemsByCustomFKFilters wsGetItemsByCustomFKFilters) throws 
         java.rmi.RemoteException;
    ...
    public com.amalto.webapp.util.webservices.WSItemPK putItemWithCustomReport(com.amalto.webapp.util.webservices.WSPutItemWithCustomReport wsPutItemWithCustomReport) throws 
         java.rmi.RemoteException;
    public com.amalto.webapp.util.webservices.WSBoolean isItemModifiedByOther(com.amalto.webapp.util.webservices.WSIsItemModifiedByOther wsItem) throws 
         java.rmi.RemoteException;
    ...
    public WSConceptRelationship getConceptRelation(String cluster) throws java.rmi.RemoteException;
}
