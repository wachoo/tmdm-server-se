...
public class WSPutItemByOperatorType_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns2myns2_WSOperatorType__WSOperatorType_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSOperatorType.class, ns2_WSOperatorType_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSPutItemByOperatorType instance = new com.amalto.webapp.util.webservices.WSPutItemByOperatorType();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_operatortype_QNAME)) {
                ...
                instance.setOperatortype((com.amalto.webapp.util.webservices.WSOperatorType)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSPutItemByOperatorType instance = (com.amalto.webapp.util.webservices.WSPutItemByOperatorType)obj;
