...
public class WSGetItems {
    ...
    public WSGetItems(com.amalto.webapp.util.webservices.WSDataClusterPK wsDataClusterPK, java.lang.String conceptName, com.amalto.webapp.util.webservices.WSWhereItem whereItem, int spellTreshold, int skip, int maxItems,boolean totalCount) {
    ...
    public void setTotalCountOnFirstResult(boolean totalCount) {
        this.totalCount = totalCount;
    }

    public boolean getTotalCountOnFirstResult() {
        return totalCount;
    }
}
