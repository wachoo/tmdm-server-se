...
public class XtentisPort_Stub
    ...
    private static final int existsDBDataCluster_OPCODE = 4;
    private static final int getConceptsInDataClusterWithRevisions_OPCODE = 5;
    private static final int putView_OPCODE = 6;
    private static final int findAllDroppedItemsPKs_OPCODE = 7;
    private static final int checkSchema_OPCODE = 8;
    ...
    private static final int logout_OPCODE = 18;
    private static final int existsView_OPCODE = 19;
    ...
    private static final int putItemByOperatorType_OPCODE = 30;
    ...
    private static final int ping_OPCODE = 50;
    ...
    private static final int putDataModel_OPCODE = 53;
    ...
    private static final int putItemWithReport_OPCODE = 58;
    ...
    private static final int putItemArray_OPCODE = 62;
    private static final int putBusinessConceptSchema_OPCODE = 63;
    private static final int existsUniverse_OPCODE = 64;
    private static final int count_OPCODE = 65;
    ...
    private static final int putBusinessConcept_OPCODE = 88;
    private static final int getTransformer_OPCODE = 89;
    private static final int deleteDataModel_OPCODE = 90;
    private static final int getItem_OPCODE = 91;
    private static final int quickSearch_OPCODE = 92;
    private static final int synchronizationPutObjectXML_OPCODE = 93;
    private static final int getDataClusterPKs_OPCODE = 94;
    ...
    private static final int getComponentVersion_OPCODE = 100;
    ...
    private static final int existsDataModel_OPCODE = 114;
    ...
    private static final int getAutoIncrement_OPCODE = 118;
    private static final int synchronizationGetUnsynchronizedObjectsIDs_OPCODE = 119;
    private static final int deleteMenu_OPCODE = 120;
    private static final int existsDataCluster_OPCODE = 121;
    private static final int executeTransformerV2_OPCODE = 122;
    private static final int getTransformerPluginV2Configuration_OPCODE = 123;
    private static final int getBackgroundJob_OPCODE = 124;
    private static final int versioningGetUniverseVersions_OPCODE = 125;
    private static final int getBusinessConceptKey_OPCODE = 126;
    private static final int findBackgroundJobPKs_OPCODE = 127;
    private static final int getItems_OPCODE = 128;
    private static final int getMDMCategory_OPCODE = 129;
    private static final int getItemPKsByFullCriteria_OPCODE = 130;
    private static final int processBytesUsingTransformerAsBackgroundJob_OPCODE = 131;
    private static final int initMDM_OPCODE = 132;
    private static final int deleteView_OPCODE = 133;
    private static final int checkServiceConfiguration_OPCODE = 134;
    ...
    private static final int existsItem_OPCODE = 142;
    ...
    private static final int getItemsPivotIndex_OPCODE = 147;
    private static final int versioningGetItemHistory_OPCODE = 148;
    private static final int getBusinessConceptValue_OPCODE = 149;
    ...
    private static final int putItemWithCustomReport_OPCODE = 155;
    ...
    private static final int getConceptsInDataCluster_OPCODE = 161;
    ...
    private static final int getChildrenItems_OPCODE = 165;
    ...
    private static final int putItem_OPCODE = 171;
