...
public class XtentisPort_Stub
     ...
     */
    public com.amalto.webapp.util.webservices.WSLicensePK putLicense(com.amalto.webapp.util.webservices.WSPutLicense putLicense)
        throws java.rmi.RemoteException {
        ...
        try {
            ...
            com.amalto.webapp.util.webservices.WSLicensePK _result = null;
            Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (com.amalto.webapp.util.webservices.WSLicensePK)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (com.amalto.webapp.util.webservices.WSLicensePK)_responseObj;
            }
     ...
     */
    public com.amalto.webapp.util.webservices.WSLicense getLicense()
        throws java.rmi.RemoteException {
        ...
        try {
            ...
            com.amalto.webapp.util.webservices.WSLicense _result = null;
            Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (com.amalto.webapp.util.webservices.WSLicense)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (com.amalto.webapp.util.webservices.WSLicense)_responseObj;
            }
    ...
    public void _initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns1_myWSPutLicense_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSPutLicense.class, ns1_WSPutLicense_TYPE_QNAME);
        ...
        ns1_myWSLicensePK_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSLicensePK.class, ns1_WSLicensePK_TYPE_QNAME);
        ...
        ns1_myWSLicense_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSLicense.class, ns1_WSLicense_TYPE_QNAME);
    ...
    private static final int versioningRestoreItems_OPCODE = 0;
    private static final int workflowGetTaskList_OPCODE = 1;
    private static final int putTransformer_OPCODE = 2;
    private static final int putDataCluster_OPCODE = 3;
    private static final int getDataCluster_OPCODE = 4;
    private static final int deleteDataCluster_OPCODE = 5;
    private static final int getView_OPCODE = 6;
    private static final int deleteSynchronizationItem_OPCODE = 7;
    private static final int deleteDataModel_OPCODE = 8;
    private static final int existsRoutingOrderV2_OPCODE = 9;
    private static final int versioningGetItemContent_OPCODE = 10;
    private static final int putVersioningSystemConfiguration_OPCODE = 11;
    private static final int getRoutingRulePKs_OPCODE = 12;
    private static final int processFileUsingTransformerAsBackgroundJob_OPCODE = 13;
    private static final int putSynchronizationPlan_OPCODE = 14;
    private static final int existsSynchronizationItem_OPCODE = 15;
    private static final int connectorInteraction_OPCODE = 16;
    private static final int synchronizationGetItemXML_OPCODE = 17;
    private static final int ping_OPCODE = 18;
    private static final int getViewPKs_OPCODE = 19;
    private static final int deleteUniverse_OPCODE = 20;
    private static final int getVersioningSystemConfiguration_OPCODE = 21;
    private static final int existsDataCluster_OPCODE = 22;
    private static final int synchronizationGetObjectXML_OPCODE = 23;
    private static final int putBackgroundJob_OPCODE = 24;
    private static final int versioningGetObjectsVersions_OPCODE = 25;
    private static final int deleteStoredProcedure_OPCODE = 26;
    private static final int existsStoredProcedure_OPCODE = 27;
    private static final int removeDroppedItem_OPCODE = 28;
    private static final int quickSearch_OPCODE = 29;
    private static final int getTransformer_OPCODE = 30;
    private static final int getStoredProcedure_OPCODE = 31;
    private static final int existsItem_OPCODE = 32;
    private static final int workflowDeploy_OPCODE = 33;
    private static final int processBytesUsingTransformer_OPCODE = 34;
    private static final int getRolePKs_OPCODE = 35;
    private static final int getBusinessConceptKey_OPCODE = 36;
    private static final int getMenuPKs_OPCODE = 37;
    private static final int resolveSynchronizationItem_OPCODE = 38;
    private static final int getDataModelPKs_OPCODE = 39;
    private static final int getSynchronizationPlan_OPCODE = 40;
    private static final int getConceptsInDataCluster_OPCODE = 41;
    private static final int getMDMCategory_OPCODE = 42;
    private static final int versioningGetItemHistory_OPCODE = 43;
    private static final int putItemByOperatorType_OPCODE = 44;
    private static final int putTransformerV2_OPCODE = 45;
    private static final int getTransformerPluginV2Configuration_OPCODE = 46;
    private static final int existsRole_OPCODE = 47;
    private static final int getUniverse_OPCODE = 48;
    private static final int getItemPKsByFullCriteria_OPCODE = 49;
    private static final int getComponentVersion_OPCODE = 50;
    private static final int putRoutingRule_OPCODE = 51;
    private static final int existsTransformerPluginV2_OPCODE = 52;
    private static final int existsDataModel_OPCODE = 53;
    private static final int getObjectsForUniverses_OPCODE = 54;
    private static final int versioningRestoreItemByRevision_OPCODE = 55;
    private static final int deleteRole_OPCODE = 56;
    private static final int getTransformerPluginV2sList_OPCODE = 57;
    private static final int putLicense_OPCODE = 58;
    private static final int executeStoredProcedure_OPCODE = 59;
    private static final int processBytesUsingTransformerAsBackgroundJob_OPCODE = 60;
    private static final int getMenu_OPCODE = 61;
    private static final int putItem_OPCODE = 62;
    private static final int getBusinessConcepts_OPCODE = 63;
    private static final int routeItemV2_OPCODE = 64;
    private static final int getItemsPivotIndex_OPCODE = 65;
    private static final int putItemWithReportArray_OPCODE = 66;
    private static final int getSynchronizationPlanPKs_OPCODE = 67;
    private static final int extractUsingTransformer_OPCODE = 68;
    private static final int putTransformerPluginV2Configuration_OPCODE = 69;
    private static final int getRoutingOrderV2PKsByCriteria_OPCODE = 70;
    private static final int getCurrentUniverse_OPCODE = 71;
    private static final int getObjectsForRoles_OPCODE = 72;
    private static final int getRole_OPCODE = 73;
    private static final int findAllDroppedItemsPKs_OPCODE = 74;
    private static final int putSynchronizationItem_OPCODE = 75;
    private static final int existsDBDataCluster_OPCODE = 76;
    private static final int synchronizationPutObjectXML_OPCODE = 77;
    private static final int extractUsingTransformerThruView_OPCODE = 78;
    private static final int getConceptsInDataClusterWithRevisions_OPCODE = 79;
    private static final int putItemArray_OPCODE = 80;
    ...
    private static final int versioningCommitItems_OPCODE = 83;
    private static final int existsUniverse_OPCODE = 84;
    private static final int versioningTagItems_OPCODE = 85;
    private static final int executeTransformerV2_OPCODE = 86;
    private static final int workflowUnDeploy_OPCODE = 87;
    private static final int deleteBusinessConcept_OPCODE = 88;
    private static final int putStoredProcedure_OPCODE = 89;
    private static final int putDataModel_OPCODE = 90;
    private static final int getBusinessConceptValue_OPCODE = 91;
    private static final int getChildrenItems_OPCODE = 92;
    private static final int synchronizationPlanAction_OPCODE = 93;
    private static final int putBusinessConceptSchema_OPCODE = 94;
    private static final int getServiceConfiguration_OPCODE = 95;
    private static final int deleteView_OPCODE = 96;
    private static final int putItemWithCustomReport_OPCODE = 97;
    private static final int versioningGetUniverseVersions_OPCODE = 98;
    private static final int versioningTagUniverse_OPCODE = 99;
    private static final int deleteTransformerV2_OPCODE = 100;
    private static final int versioningGetInfo_OPCODE = 101;
    private static final int getTransformerPKs_OPCODE = 102;
    private static final int synchronizationGetUnsynchronizedObjectsIDs_OPCODE = 103;
    private static final int versioningTagObjects_OPCODE = 104;
    private static final int deleteRoutingOrderV2_OPCODE = 105;
    private static final int workflowGetProcessDefinitions_OPCODE = 106;
    private static final int deleteRoutingRule_OPCODE = 107;
    private static final int getSynchronizationPlanItemsAlgorithms_OPCODE = 108;
    private static final int putRole_OPCODE = 109;
    private static final int workflowGetProcessInstances_OPCODE = 110;
    private static final int routingEngineV2Action_OPCODE = 111;
    private static final int synchronizationPutItemXML_OPCODE = 112;
    private static final int getDataModel_OPCODE = 113;
    private static final int serviceAction_OPCODE = 114;
    private static final int existsRoutingRule_OPCODE = 115;
    private static final int recoverDroppedItem_OPCODE = 116;
    private static final int putMDMJob_OPCODE = 117;
    private static final int getSynchronizationPlanObjectsAlgorithms_OPCODE = 118;
    private static final int existsMenu_OPCODE = 119;
    private static final int getDataClusterPKs_OPCODE = 120;
    private static final int getTransformerV2PKs_OPCODE = 121;
    private static final int executeTransformerV2AsJob_OPCODE = 122;
    private static final int versioningRestoreUniverse_OPCODE = 123;
    private static final int versioningGetItemsVersions_OPCODE = 124;
    private static final int putBusinessConcept_OPCODE = 125;
    private static final int versioningRestoreObjects_OPCODE = 126;
    private static final int getItem_OPCODE = 127;
    private static final int getMDMJob_OPCODE = 128;
    private static final int getItems_OPCODE = 129;
    private static final int deleteTransformer_OPCODE = 130;
    private static final int logout_OPCODE = 131;
    private static final int existsView_OPCODE = 132;
    private static final int loadDroppedItem_OPCODE = 133;
    private static final int putItemWithReport_OPCODE = 134;
    private static final int getTransformerV2_OPCODE = 135;
    private static final int getObjectsForSynchronizationPlans_OPCODE = 136;
    private static final int existsSynchronizationPlan_OPCODE = 137;
    private static final int dropItem_OPCODE = 138;
    private static final int deleteMDMJob_OPCODE = 139;
    private static final int deleteSynchronizationPlan_OPCODE = 140;
    private static final int getServiceDocument_OPCODE = 141;
    private static final int getFullPathValues_OPCODE = 142;
    private static final int getRoutingRule_OPCODE = 143;
    private static final int findBackgroundJobPKs_OPCODE = 144;
    private static final int getBackgroundJob_OPCODE = 145;
    private static final int putMenu_OPCODE = 146;
    private static final int viewSearch_OPCODE = 147;
    private static final int deleteMenu_OPCODE = 148;
    private static final int putView_OPCODE = 149;
    private static final int executeRoutingOrderV2Synchronously_OPCODE = 150;
    private static final int executeRoutingOrderV2Asynchronously_OPCODE = 151;
    private static final int existsTransformer_OPCODE = 152;
    private static final int getSynchronizationItemPKs_OPCODE = 153;
    private static final int deleteItems_OPCODE = 154;
    private static final int getLicense_OPCODE = 155;
    private static final int initMDM_OPCODE = 156;
    private static final int getMDMConfiguration_OPCODE = 157;
    private static final int deleteItem_OPCODE = 158;
    private static final int workflowDeleteProcessInstances_OPCODE = 159;
    private static final int getItemPKsByCriteria_OPCODE = 160;
    private static final int putDBDataCluster_OPCODE = 161;
    private static final int getServicesList_OPCODE = 162;
    private static final int checkServiceConfiguration_OPCODE = 163;
    private static final int getSynchronizationItem_OPCODE = 164;
    private static final int xPathsSearch_OPCODE = 165;
    private static final int checkSchema_OPCODE = 166;
    private static final int existsTransformerV2_OPCODE = 167;
    private static final int runQuery_OPCODE = 168;
    private static final int putServiceConfiguration_OPCODE = 169;
    private static final int getRoutingOrderV2_OPCODE = 170;
    private static final int count_OPCODE = 171;
    private static final int getRoutingOrderV2sByCriteria_OPCODE = 172;
    private static final int processFileUsingTransformer_OPCODE = 173;
    private static final int extractThroughTransformerV2_OPCODE = 174;
    private static final int getUniverseByRevision_OPCODE = 175;
    private static final int getStoredProcedurePKs_OPCODE = 176;
    private static final int putUniverse_OPCODE = 177;
    private static final int getTransformerPluginV2Details_OPCODE = 178;
