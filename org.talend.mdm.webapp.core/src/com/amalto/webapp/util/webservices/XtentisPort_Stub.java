...
public class XtentisPort_Stub
    ...
    private static final int deleteItems_OPCODE = 3;
    private static final int putItemWithReport_OPCODE = 4;
    ...
    private static final int deleteMDMJob_OPCODE = 13;
    private static final int executeTransformerV2AsJob_OPCODE = 14;
    private static final int putView_OPCODE = 15;
    private static final int connectorInteraction_OPCODE = 16;
    private static final int workflowUnDeploy_OPCODE = 17;
    private static final int getBusinessConceptKey_OPCODE = 18;
    private static final int getDataModel_OPCODE = 19;
    private static final int putSynchronizationPlan_OPCODE = 20;
    private static final int viewSearch_OPCODE = 21;
    private static final int putItemWithCustomReport_OPCODE = 22;
    private static final int synchronizationPutItemXML_OPCODE = 23;
    private static final int existsDBDataCluster_OPCODE = 24;
    private static final int deleteBusinessConcept_OPCODE = 25;
    private static final int existsSynchronizationPlan_OPCODE = 26;
    private static final int getMenuPKs_OPCODE = 27;
    private static final int getObjectsForRoles_OPCODE = 28;
    private static final int getConceptsInDataClusterWithRevisions_OPCODE = 29;
    private static final int deleteMenu_OPCODE = 30;
    private static final int getTransformer_OPCODE = 31;
    private static final int deleteRole_OPCODE = 32;
    private static final int putServiceConfiguration_OPCODE = 33;
    private static final int versioningGetItemContent_OPCODE = 34;
    private static final int executeRoutingOrderV2Synchronously_OPCODE = 35;
    private static final int putItemArray_OPCODE = 36;
    private static final int existsUniverse_OPCODE = 37;
    private static final int getFullPathValues_OPCODE = 38;
    private static final int workflowDeleteProcessInstances_OPCODE = 39;
    private static final int dropItem_OPCODE = 40;
    private static final int getObjectsForUniverses_OPCODE = 41;
    private static final int getTransformerPKs_OPCODE = 42;
    private static final int getBackgroundJob_OPCODE = 43;
    private static final int versioningTagUniverse_OPCODE = 44;
    private static final int executeRoutingOrderV2Asynchronously_OPCODE = 45;
    private static final int removeDroppedItem_OPCODE = 46;
    private static final int existsView_OPCODE = 47;
    private static final int getStoredProcedure_OPCODE = 48;
    private static final int findBackgroundJobPKs_OPCODE = 49;
    private static final int putTransformerPluginV2Configuration_OPCODE = 50;
    private static final int existsItem_OPCODE = 51;
    private static final int workflowGetTaskList_OPCODE = 52;
    private static final int getDataClusterPKs_OPCODE = 53;
    private static final int deleteUniverse_OPCODE = 54;
    private static final int getBusinessConcepts_OPCODE = 55;
    private static final int getRoutingOrderV2sByCriteria_OPCODE = 56;
    private static final int existsRoutingOrderV2_OPCODE = 57;
    private static final int putTransformer_OPCODE = 58;
    private static final int putMenu_OPCODE = 59;
    private static final int versioningGetUniverseVersions_OPCODE = 60;
    private static final int routingEngineV2Action_OPCODE = 61;
    private static final int count_OPCODE = 62;
    private static final int existsTransformer_OPCODE = 63;
    private static final int findAllDroppedItemsPKs_OPCODE = 64;
    private static final int putStoredProcedure_OPCODE = 65;
    private static final int processFileUsingTransformer_OPCODE = 66;
    private static final int putMDMJob_OPCODE = 67;
    private static final int putBackgroundJob_OPCODE = 68;
    private static final int getTransformerV2_OPCODE = 69;
    private static final int resolveSynchronizationItem_OPCODE = 70;
    private static final int workflowGetProcessInstances_OPCODE = 71;
    private static final int routeItemV2_OPCODE = 72;
    private static final int deleteRoutingOrderV2_OPCODE = 73;
    private static final int extractUsingTransformer_OPCODE = 74;
    private static final int existsTransformerV2_OPCODE = 75;
    private static final int runQuery_OPCODE = 76;
    private static final int existsDataCluster_OPCODE = 77;
    private static final int processBytesUsingTransformer_OPCODE = 78;
    private static final int putDataModel_OPCODE = 79;
    private static final int checkServiceConfiguration_OPCODE = 80;
    private static final int putUniverse_OPCODE = 81;
    private static final int getMDMConfiguration_OPCODE = 82;
    private static final int synchronizationPlanAction_OPCODE = 83;
    ...
    private static final int deleteRoutingRule_OPCODE = 88;
    private static final int deleteStoredProcedure_OPCODE = 89;
    private static final int putItem_OPCODE = 90;
    private static final int getRole_OPCODE = 91;
    private static final int deleteDataModel_OPCODE = 92;
    private static final int putRoutingRule_OPCODE = 93;
    private static final int processFileUsingTransformerAsBackgroundJob_OPCODE = 94;
    private static final int getSynchronizationPlanPKs_OPCODE = 95;
    private static final int putDataCluster_OPCODE = 96;
    private static final int getSynchronizationPlanItemsAlgorithms_OPCODE = 97;
    private static final int getView_OPCODE = 98;
    private static final int versioningTagItems_OPCODE = 99;
    private static final int getComponentVersion_OPCODE = 100;
    private static final int getObjectsForSynchronizationPlans_OPCODE = 101;
    private static final int versioningRestoreItemByRevision_OPCODE = 102;
    ...
    private static final int getSynchronizationItemPKs_OPCODE = 105;
    private static final int getTransformerPluginV2Details_OPCODE = 106;
    private static final int checkSchema_OPCODE = 107;
    private static final int getRoutingOrderV2PKsByCriteria_OPCODE = 108;
    private static final int loadDroppedItem_OPCODE = 109;
    private static final int getItem_OPCODE = 110;
    private static final int getConceptsInDataCluster_OPCODE = 111;
    private static final int getTransformerPluginV2sList_OPCODE = 112;
    private static final int putBusinessConcept_OPCODE = 113;
    private static final int getTransformerPluginV2Configuration_OPCODE = 114;
    private static final int getUniverse_OPCODE = 115;
    private static final int versioningRestoreUniverse_OPCODE = 116;
    private static final int versioningTagObjects_OPCODE = 117;
    private static final int putItemWithReportArray_OPCODE = 118;
    private static final int synchronizationGetObjectXML_OPCODE = 119;
    private static final int getCurrentUniverse_OPCODE = 120;
    private static final int quickSearch_OPCODE = 121;
    private static final int synchronizationGetUnsynchronizedObjectsIDs_OPCODE = 122;
    private static final int getServiceConfiguration_OPCODE = 123;
    private static final int getServicesList_OPCODE = 124;
    private static final int versioningGetItemsVersions_OPCODE = 125;
    private static final int deleteView_OPCODE = 126;
    private static final int getDataCluster_OPCODE = 127;
    private static final int getRoutingRule_OPCODE = 128;
    private static final int putVersioningSystemConfiguration_OPCODE = 129;
    private static final int getViewPKs_OPCODE = 130;
    private static final int processBytesUsingTransformerAsBackgroundJob_OPCODE = 131;
    private static final int getMDMJob_OPCODE = 132;
    private static final int logout_OPCODE = 133;
    private static final int deleteTransformerV2_OPCODE = 134;
    private static final int putRole_OPCODE = 135;
    private static final int serviceAction_OPCODE = 136;
    private static final int existsTransformerPluginV2_OPCODE = 137;
    private static final int synchronizationGetUnsynchronizedItemPKs_OPCODE = 138;
    private static final int synchronizationGetItemXML_OPCODE = 139;
    private static final int getUniversePKs_OPCODE = 140;
    private static final int existsStoredProcedure_OPCODE = 141;
    private static final int getUniverseByRevision_OPCODE = 142;
    private static final int existsRoutingRule_OPCODE = 143;
    private static final int deleteSynchronizationItem_OPCODE = 144;
    private static final int putSynchronizationItem_OPCODE = 145;
    private static final int versioningCommitItems_OPCODE = 146;
    private static final int putTransformerV2_OPCODE = 147;
    private static final int deleteTransformer_OPCODE = 148;
    private static final int getBusinessConceptValue_OPCODE = 149;
    private static final int getTransformerV2PKs_OPCODE = 150;
    private static final int getServiceDocument_OPCODE = 151;
    private static final int initMDM_OPCODE = 152;
    private static final int putBusinessConceptSchema_OPCODE = 153;
    private static final int deleteItem_OPCODE = 154;
    private static final int getRolePKs_OPCODE = 155;
    private static final int xPathsSearch_OPCODE = 156;
    private static final int getStoredProcedurePKs_OPCODE = 157;
    private static final int versioningGetInfo_OPCODE = 158;
    private static final int existsDataModel_OPCODE = 159;
    private static final int executeTransformerV2_OPCODE = 160;
    private static final int existsRole_OPCODE = 161;
    private static final int getSynchronizationItem_OPCODE = 162;
    private static final int executeStoredProcedure_OPCODE = 163;
    private static final int ping_OPCODE = 164;
    private static final int recoverDroppedItem_OPCODE = 165;
    ...
    private static final int workflowGetProcessDefinitions_OPCODE = 168;
    private static final int getMenu_OPCODE = 169;
    private static final int getDataModelPKs_OPCODE = 170;
    private static final int workflowDeploy_OPCODE = 171;
    private static final int getRoutingOrderV2_OPCODE = 172;
